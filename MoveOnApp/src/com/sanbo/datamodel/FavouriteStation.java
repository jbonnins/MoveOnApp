...
CREATE TABLE "FavouriteStation" ("_id" INTEGER PRIMARY KEY ASC AUTOINCREMENT NOT NULL UNIQUE, "FK_id_Station" INTEGER NOT NULL, "Name" TEXT)
*/
...
public class FavouriteStation {
	 ...
	 * @param name
	 */
	public FavouriteStation(int _id, int fK_id_Station, String name) {
		this._id = _id;
	...
	public boolean equals(Object obj) {
		...
		FavouriteStation other = (FavouriteStation) obj;
		if (_id != other._id) {
			return false;
		}
		return true;
